...
int main()
{
   ...
   string name;
   int position, material, arrayWidth, arrayLength, X_MOVE, Y_MOVE;
   ...
   cout << "Enter a length for the array (up to 8): ";
   cin >> arrayLength;

   if (arrayLength > 8 || arrayLength < 1)
   {
      cout << "please enter a valid width\n";
   }
   ...
   cout << arrayWidth << "x" << arrayLength << endl;
   ...
   arrayPrint(material, arrayWidth, arrayLength, X_MOVE, Y_MOVE);
   ...
   switch(material)
   {
      case 1:
         for (int row = 0; row < arrayLength; row++)
         {
            ...
            if (row < 2)
            {
               cout << "G1 Y" << X_MOVE << " F" << FR_MOVE_XY << endl;
               cout << "G1 Z-" << Z_MOVE << " F" << Z_FEEDRATE << endl;
            }
            else
               cout << endl;
